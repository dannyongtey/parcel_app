...
class ParcelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parcel" do
    assert_difference('Parcel.count') do
      post parcels_url, params: { parcel: { courier: @parcel.courier, name: @parcel.name, phone: @parcel.phone, quantity: @parcel.quantity, remakrs: @parcel.remakrs } }
    end
  ...
  test "should update parcel" do
    patch parcel_url(@parcel), params: { parcel: { courier: @parcel.courier, name: @parcel.name, phone: @parcel.phone, quantity: @parcel.quantity, remakrs: @parcel.remakrs } }
